...
#define CUSTOM_MENDEL_NAME "PI3 pro X2"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {79.65,79.65,2560,95}  // MXL, Z M8=1.25, MK8
...
#define EXTRUDER_OFFSET_X {0.0, 27.55} //28.2
#define EXTRUDER_OFFSET_Y {0.0,  1.25} //-3.0
